...
public class LongField implements PetriSerializable {
    ...
    public String deserializeDataInput(String dataInput, Writer out) {
        out.write(String.format(
                "final long deserialized = org.dhbw.ka.ml.petrilib.serializing.primitives.PetriLong.deserialize(%s);",
                dataInput
        ));
        return "deserialized";
    }
    ...
    public void skip(String dataInput, Writer out) {
        out.write(String.format(
                "org.dhbw.ka.ml.petrilib.serializing.primitives.PetriLong.skip(%s);",
                dataInput
        ));
    }
}
