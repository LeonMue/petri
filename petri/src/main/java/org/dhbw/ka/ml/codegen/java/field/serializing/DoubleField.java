...
public class DoubleField implements PetriSerializable {
    ...
    public String deserializeDataInput(String dataInput, Writer out) {
        out.write(String.format(
                "final double deserialized = org.dhbw.ka.ml.petrilib.serializing.primitives.PetriDouble.deserialize(%s);",
                dataInput
        ));
        return "deserialized";
    }
    ...
    public void skip(String dataInput, Writer out) {
        out.write(String.format(
                "org.dhbw.ka.ml.petrilib.serializing.primitives.PetriDouble.skip(%s);",
                dataInput
        ));
    }
}
